...
//tranzemos o contexto para o newTransactionModal
//Respeitando a imutabilidade
//Vamos pegar toda a logica de criação de uma nova transação e passar para o nosso context
