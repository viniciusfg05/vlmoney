...
export function TransitionsTable() {
  ...
  //Erro (index.tsx:52 Uncaught TypeError: transactions.map is not a function) - A nossa requisição da api quando damos  console.log(response.data)) ele retorna uma objeto e n~]ao diretamento uma array 
